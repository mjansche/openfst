...
const uint64 kWeightedCycles = 0x0000400000000000ULL;

// Only unweighted cycles.
const uint64 kUnweightedCycles = 0x0000800000000000ULL;
...
const uint64 kTrinaryProperties = 0x0000ffffffff0000ULL;
...
const uint64 kPosTrinaryProperties = kTrinaryProperties & 0x5555555555555555ULL;

// 2nd bit of trinary properties
const uint64 kNegTrinaryProperties = kTrinaryProperties & 0xaaaaaaaaaaaaaaaaULL;
