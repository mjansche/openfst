...
int fstcompile_main(int argc, char **argv) {
  ...
  s::CompileFst(
      istrm, source, dest, FST_FLAGS_fst_type, FST_FLAGS_arc_type, isyms.get(),
      osyms.get(), ssyms.get(), FST_FLAGS_acceptor,
      FST_FLAGS_keep_isymbols, FST_FLAGS_keep_osymbols,
